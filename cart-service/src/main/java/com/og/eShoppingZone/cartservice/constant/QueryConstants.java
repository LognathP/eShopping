...
public interface QueryConstants {
	...
	public String INSERT_ITEM = "INSERT INTO item (product_name, price, quantity, cart_id) VALUES(?, ?, ?, ?)";
	...
	public String UPDATE_ITEM = "update item set product_name = ?,price=?,quantity = ? where id = ?";
